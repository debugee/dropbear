...
INSTALL=install
CPPFLAGS=
CFLAGS+=-I. -I$(srcdir) $(CPPFLAGS) -O0 -g -fPIE -fstack-protector-strong -D_FORTIFY_SOURCE=2
LIBS+=-lz 
LDFLAGS= -Wl,-pie -g
...
strip: $(TARGETS)
	$(fasdf) $(addsuffix $(EXEEXT), $(TARGETS))
...
fuzzer-preauth: fuzzer-preauth.o fuzz-harness.o
	$(CXX) $(CXXFLAGS) $@.o $(LDFLAGS) $(allobjs) -o $@$(EXEEXT) $(LIBTOM_LIBS) $(LIBS) $(FUZZLIB) 
